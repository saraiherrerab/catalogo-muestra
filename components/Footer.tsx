    ...
    <footer className="bg-gray-900">
      <div className="mx-auto w-full max-w-screen-xl">
        <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
          <div>
            ...
            <ul className="text-gray-400 font-medium">
              <li className="mb-4">
                <a href="/nosotros" className="hover:underline">About</a>
              </li>
              <li className="mb-4">
          ...
          <div>
            ...
            <ul className="text-gray-400 font-medium">
              ...
              <li className="mb-4">
                <a href="/contacto" className="hover:underline">Contact Us</a>
              </li>
            </ul>
          </div>
          <div>
        ...
        <div className="px-4 py-6 bg-gray-800 md:flex md:items-center md:justify-between">
          <span className="text-sm text-gray-400 sm:text-center">© 2024 Catálogo de Productos Petroleros. All Rights Reserved.</span>
